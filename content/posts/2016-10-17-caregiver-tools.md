...
date: 2016-10-17T20:20:56
slug: "caregiver-tools"
author: "Eric Harris-Braun"
categories:
  - "uncategorized"
---

<img class="alignright size-medium wp-image-1406" src="/blog/images/Caregiver-tools1.jpg" alt="caregiver-tools1" />One gorgeous October day after the next comes and goes, and the moon now wanes after filling the eastern sky with magnificent moon rises these past evenings. Ellen has endured increased pain and discomfort, and her caregivers adjust this and that to find the best way to ease her journey. We wonder how much longer she can persevere and whether we have done an adequate job in helping her complete what she needed to get done and in giving her permission to let go and die.
...
<img class="alignleft size-medium wp-image-1404" src="/blog/images/Caregiver-tools9.jpg" alt="caregiver-tools9" />Clipboard - The clipboard goes back and forth but mostly can be found on the bedside table upstairs near Ellen. It holds a chart on which the person at her side can track her sleeping and check timing of medications and comfort measures to ensure they are administered relatively close to "on schedule" - sometimes a challenge, as we don't want to wake her to give her meds.

White Binder and Purple Pen - The front cover presents Key Information. Inside the front cover are Important Documents like Ellen's <a href="https://www.health.ny.gov/professionals/patients/patient_rights/molst/">MOLST</a>, and the sections include emergency protocols, medication information, the daily care checklist, the log, the list of folks in the rings around Ellen and contact info, and more. The contents of the binder grow steadily as we add a care checklist each day and caregivers get more comfortable with writing anything and everything in the <img class="size-medium wp-image-1405 alignright" src="/blog/images/Caregiver-tools10.jpg" alt="caregiver-tools10" />log that might be of use to other caregivers.  It turns out the log serves other purposes, one of which is to help an individual caregiver decompress after time with Ellen, even dump out one's thoughts and feelings in a cathartic way.

<img class="size-medium wp-image-1407 alignleft" src="/blog/images/Caregiver-tools11.jpg" alt="caregiver-tools11" />
...
<span class="comment-author">Shelly</span>
 &mdash; October 17, 2016 at 09:40 PM
</div>
<div class="comment-content"><p>This seems a horrible journey that you are all finding a way to make somehow beautiful, too. But painful. I wish none of you, especially Ellen, had to go through this. And I wish most of all for a timely and as-peaceful-as-possible transition for Ellen and the whole extended family. Thinking of all of you, as always.</p></div>
</div>
<div class="comment">
<div class="comment-meta">
<span class="comment-author">Dorian</span>
 &mdash; October 17, 2016 at 11:20 PM
</div>
<div class="comment-content"><p>Continued thanks to Eric and Spee for taking the time and energy to post these updates. I know so many of us think of all of you there all the time, feeling wondering and worrying and unable to help. Our needs are completely beside the point, but I am so appreciative of your posts.</p></div>
</div>
</div>
